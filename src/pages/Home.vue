...
const {isLoading, getImage: data } = storeToRefs(fetchData);
...
function toggleDetailModel(detail){
        ...
        <div class="">
          ...
          >
            ...
            >
              ...
              <DetailModel :item="selectedItem" :show="showPopup" @toggleDetailModel="toggleDetailModel" />
            </div>
          </div>
        </div>
